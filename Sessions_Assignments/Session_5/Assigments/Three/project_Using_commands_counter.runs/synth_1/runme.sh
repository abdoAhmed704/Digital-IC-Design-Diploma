...
HD_PWD='C:/Users/ABDOU/Desktop/Digital World/Digital Ic Diploma/design/section 5/Assigments/THREE/project_Using_commands_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log monitor_111.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source monitor_111.tcl
