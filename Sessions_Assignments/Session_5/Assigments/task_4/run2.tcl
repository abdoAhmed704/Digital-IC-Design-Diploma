create_project project_Using_commands_counter "C:/Users/ABDOU/Desktop/Digital World/Digital Ic Diploma/design/section 5/Assigments/FOUR" -part xc7a35ticpg236-1L -force

## Add source files & XDC files
add_files memory_design.v

## Elaborate Design (Will open the schematic)
synth_design -rtl -top RAM_SINGLE_PORT > elab.log
