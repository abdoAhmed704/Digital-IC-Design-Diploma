create_project project_Using_commands_counter "C:/Users/ABDOU/Desktop/Digital World/Digital Ic Diploma/design/section 5/Assigments/FIVE" -part xc7a35ticpg236-1L -force

## Add source files & XDC files
add_files fifo_ram.v

## Elaborate Design (Will open the schematic)
synth_design -rtl -top FIFO_RAM > elab.log
